...
/* structure definitions for \uscheme 186c */
struct Env {
    Name name;
    Value *loc;
    Env tl;
...
/* function prototypes for \uscheme 181a */
void pushroot(Root r);
void poproot (Root r);
/* function prototypes for \uscheme 181b */
Value *allocloc(void);
/* function prototypes for \uscheme 182a */
void resetrootstack(void);
/* function prototypes for \uscheme 182b */
extern Root *rootstack;
extern int rootstacksize;
/* function prototypes for \uscheme 182c */
void printroots(void);
/* function prototypes for \uscheme 627c */
int gammadesired(int defaultval, int minimum);
/* function prototypes for \uscheme 627d */
